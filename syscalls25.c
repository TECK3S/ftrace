...
void	tr_clone(struct user_regs_struct * reg,
      enum mode the_mode,
      pid_t pid,
  ...
  if (the_mode == PARAM)
    {
      ...
      nbChars = sprintf(sym->debug_info, "Parameters (%p, %p, %s, %p",
        (void *)reg->ebx,
        (void *)reg->ecx,
        p_clone_flag(reg->edx, pid),
        (void *)reg->esi);
...
void	tr_setdomainname(struct user_regs_struct * reg,
      enum mode the_mode,
      pid_t pid,
      t_symbol_graph * graph)
{
...
void	tr_uname(struct user_regs_struct * reg,
      enum mode the_mode,
      pid_t pid,
      t_symbol_graph * graph)
{
...
void	tr_modify_ldt(struct user_regs_struct * reg,
      enum mode the_mode,
      pid_t pid,
      t_symbol_graph * graph)
{
...
void	tr_adjtimex(struct user_regs_struct * reg,
      enum mode the_mode,
      pid_t pid,
      t_symbol_graph * graph)
{
